      ...
      <div className='container flex flex-col flex-wrap px-5 py-20 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap'>
        ...
        <div className='flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left'>
          <div className='w-full px-4 lg:w-1/4 md:w-1/2'>
            <h2 className='mb-3 text-sm font-medium tracking-widest  text-orange-600 uppercase title-font'>
              <Link to='/'> Home</Link>
            </h2>
            <nav className='mb-10 list-none'>
              ...
              <li className='mt-3'>
                <a className='text-gray-500 cursor-pointer hover:text-orange-600'>
                  Post a job
                </a>
              </li>
              <li className='mt-3'>
